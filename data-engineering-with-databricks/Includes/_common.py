...
course_config = CourseConfig(course_code = "delp",
                             ...
                             supported_dbrs = ["13.3.x-scala2.12", "13.3.x-photon-scala2.12", "13.3.x-cpu-ml-scala2.12","14.3.x-scala2.12"],
                             expected_dbrs = "13.3.x-scala2.12, 13.3.x-photon-scala2.12, 13.3.x-cpu-ml-scala2.12,14.3.x-scala2.12")
